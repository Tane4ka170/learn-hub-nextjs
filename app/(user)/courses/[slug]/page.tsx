  ...
  if (!course) {
    return (
      <div className="container mx-auto px-4 py-8 mt-16">
        <h1 className="text-4xl font-bold">Course unavailable</h1>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black to-black/65" />
        <div className="absolute inset-0 container mx-auto px-4 flex flex-col justify-end pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-lg text-white/35 max-w-2xl">
                {course.description}
              </p>
            </div>
            <div className="bg-white/25 backdrop-blur-sm rounded-lg p-6 md:min-w-[300px]">
