...
function Header() {
  return (
    <header className="sticky top-0 z-50 bg-background/25 backdrop-blur-sm border-b border-border">
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-primary/55 to-primary bg-clip-text text-transparent">
                Learn Hub
              </span>
            </Link>
            <SearchInput />
